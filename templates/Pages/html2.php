...
<body>
  ...
  "properties" : {
    ...
    "event_details_json" : {
      "$ref" : "#/components/schemas/EventDetailsData"
    }
  },
  "xml" : {
    "name" : "Event"
  ...
  "properties" : {
    ...
    "delivery_types" : {
      ...
      "items" : {
        "$ref" : "#/components/schemas/DeliveryTypeData"
      }
    }
  },
  "xml" : {
  ...
  "properties" : {
    ...
    "destination" : {
      "type" : "string",
      "description" : "mail adress or phone number etc"
    },
    "text" : {
      "type" : "string",
      "description" : "text of nottification based on delivery type"
    }
  },
  "xml" : {
    "name" : "DeliveryTypeData"
  }
};
            defs.EventDetailsData = {
  "type" : "object",
  "properties" : {
    "name" : {
      "type" : "string"
  ...
  "properties" : {
    ...
    "ical_raw" : {
      "type" : "string",
      "description" : "описание события в формате ical",
      "format" : "ical"
    },
    "status" : {
      "type" : "integer",
      "description" : "status of event object",
      "format" : "Int32",
      "default" : 0,
      "enum" : [ 0, 1 ]
    }
  ...
  "properties" : {
    ...
    "status" : {
      "type" : "integer",
      "description" : "status of notification object",
      "format" : "Int32",
      "default" : 0,
      "enum" : [ 0, 1, 2 ]
    }
  ...
  "properties" : {
    ...
    "byday" : {
      ...
      "items" : {
        "type" : "string",
        "format" : "[[+/-]1..53]MO/TU/WE/TH/FR/SA/SU"
      }
    },
    "bymonthday" : {
      "type" : "array",
        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Events"><a href="#api-Events">API Methods - Events</a></li>
                    <li data-group="Events" data-name="closeEvent" class="">
                      <a href="#api-Events-closeEvent">closeEvent</a>
                    </li>
                    <li data-group="Events" data-name="createEvent" class="">
                      <a href="#api-Events-createEvent">createEvent</a>
                    </li>
                    <li data-group="Events" data-name="editEvent" class="">
                      <a href="#api-Events-editEvent">editEvent</a>
                    </li>
                    <li data-group="Events" data-name="getEvent" class="">
                      <a href="#api-Events-getEvent">getEvent</a>
                    </li>
                    <li data-group="Events" data-name="getEventNotifications" class="">
                      <a href="#api-Events-getEventNotifications">getEventNotifications</a>
                    </li>
                  <li class="nav-header" data-group="Notifications"><a href="#api-Notifications">API Methods - Notifications</a></li>
                    <li data-group="Notifications" data-name="createNotification" class="">
                      <a href="#api-Notifications-createNotification">createNotification</a>
                    </li>
                    <li data-group="Notifications" data-name="deleteNotification" class="">
                      <a href="#api-Notifications-deleteNotification">deleteNotification</a>
                    </li>
                    <li data-group="Notifications" data-name="editNotification" class="">
                      <a href="#api-Notifications-editNotification">editNotification</a>
                    </li>
                    <li data-group="Notifications" data-name="getEventNotifications" class="">
                      <a href="#api-Notifications-getEventNotifications">getEventNotifications</a>
                    </li>
                    <li data-group="Notifications" data-name="getNotification" class="">
                      <a href="#api-Notifications-getNotification">getNotification</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>This API allows you to notify your users about events.</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Events">
                  <h1>Events</h1>
                    <div id="api-Events-closeEvent">
                      <article id="api-Events-closeEvent-0" data-group="User" data-name="closeEvent" data-version="0">
                        <div class="pull-left">
                          <h1>closeEvent</h1>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">delete specific event object by id, this id becomes unavailable</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/api/events/{eventid}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Events-closeEvent-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Events-closeEvent-0-java">Java</a></li>
                          <li class=""><a href="#examples-Events-closeEvent-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Events-closeEvent-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Events-closeEvent-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Events-closeEvent-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Events-closeEvent-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Events-closeEvent-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Events-closeEvent-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Events-closeEvent-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Events-closeEvent-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Events-closeEvent-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/events/{eventid}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Events-closeEvent-0-java">
...
public class EventsApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            apiInstance.closeEvent(eventid);
        } catch (ApiException e) {
            System.err.println("Exception when calling EventsApi#closeEvent");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Events-closeEvent-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Events-closeEvent-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Events-closeEvent-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *eventid = eventid_example; // ID of event to delete

EventsApi *apiInstance = [[EventsApi alloc] init];

// delete event object
[apiInstance closeEventWith:eventid
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Events-closeEvent-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');

var api = new NotifierResTfulApi.EventsApi()
...
api.closeEvent(eventid, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Events-closeEvent-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Events-closeEvent-0-csharp">
...
namespace Example
{
    public class closeEventExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling EventsApi.closeEvent: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Events-closeEvent-0-php">
...
try {
    $api_instance->closeEvent($eventid);
} catch (Exception $e) {
    echo 'Exception when calling EventsApi->closeEvent: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-closeEvent-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EventsApi;

my $api_instance = WWW::SwaggerClient::EventsApi->new();
my $eventid = eventid_example; # String | ID of event to delete

eval { 
    $api_instance->closeEvent(eventid => $eventid);
};
if ($@) {
    warn "Exception when calling EventsApi->closeEvent: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-closeEvent-0-python">
...
try: 
    # delete event object
    api_instance.close_event(eventid)
except ApiException as e:
    print("Exception when calling EventsApi->closeEvent: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">eventid*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_closeEvent_eventid">
                          ...
                          <h2>Responses</h2>
                            ...
                            <h3> Status: 404 - event not found by this id </h3>
                            ...
                            <h3> Status: 410 - event was deleted, this id is not available anymore </h3>
                      ...
                      <hr>
                    <div id="api-Events-createEvent">
                      <article id="api-Events-createEvent-0" data-group="User" data-name="createEvent" data-version="0">
                        <div class="pull-left">
                          <h1>createEvent</h1>
                          <p>create new event object</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">you describe event in request body and get new event object as response</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/api/events/new</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Events-createEvent-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Events-createEvent-0-java">Java</a></li>
                          <li class=""><a href="#examples-Events-createEvent-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Events-createEvent-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Events-createEvent-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Events-createEvent-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Events-createEvent-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Events-createEvent-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Events-createEvent-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Events-createEvent-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Events-createEvent-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Events-createEvent-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/events/new"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Events-createEvent-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
    ...
    public static void main(String[] args) {
        ...
        EventsApi apiInstance = new EventsApi();
        CreateEventData body = ; // CreateEventData | General information about event
        try {
            EventObject result = apiInstance.createEvent(body);
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Events-createEvent-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Events-createEvent-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Events-createEvent-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">CreateEventData *body = ; // General information about event

EventsApi *apiInstance = [[EventsApi alloc] init];

// create new event object
[apiInstance createEventWith:body
              completionHandler: ^(EventObject output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Events-createEvent-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');

var api = new NotifierResTfulApi.EventsApi()
var body = ; // {{CreateEventData}} General information about event
...
api.createEvent(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Events-createEvent-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Events-createEvent-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class createEventExample
    {
        public void main()
        {
            ...
            var apiInstance = new EventsApi();
            var body = new CreateEventData(); // CreateEventData | General information about event
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling EventsApi.createEvent: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Events-createEvent-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiEventsApi();
$body = ; // CreateEventData | General information about event
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Events-createEvent-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EventsApi;

my $api_instance = WWW::SwaggerClient::EventsApi->new();
my $body = WWW::SwaggerClient::Object::CreateEventData->new(); # CreateEventData | General information about event
...
if ($@) {
    warn "Exception when calling EventsApi->createEvent: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-createEvent-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling EventsApi->createEvent: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                $(document).ready(function() {
                                  var schemaWrapper = {
  "description" : "General information about event",
  "content" : {
    "application/json" : {
      "schema" : {
  ...
  "required" : true
                                  ...
                                  var result = $('#d2e199_createEvent_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_createEvent_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 201 - new object successfully created </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-createEvent-201-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-createEvent-201-schema">
                                  <div id='responses-createEvent-201-schema-201' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "new object successfully created",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/EventObject"
                                        ...
                                        $('#responses-createEvent-201-schema-data').val(stringify(schema));
                                        var result = $('#responses-createEvent-201-schema-201');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-createEvent-201-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - creation error occured </h3>
                      ...
                      <hr>
                    <div id="api-Events-editEvent">
                      <article id="api-Events-editEvent-0" data-group="User" data-name="editEvent" data-version="0">
                        <div class="pull-left">
                          <h1>editEvent</h1>
                          <p>modify event object</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">edit any field of specific event object and get modified event object as response</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/api/events/{eventid}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Events-editEvent-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Events-editEvent-0-java">Java</a></li>
                          <li class=""><a href="#examples-Events-editEvent-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Events-editEvent-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Events-editEvent-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Events-editEvent-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Events-editEvent-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Events-editEvent-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Events-editEvent-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Events-editEvent-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Events-editEvent-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Events-editEvent-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/events/{eventid}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Events-editEvent-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
    ...
    public static void main(String[] args) {
        ...
        EventsApi apiInstance = new EventsApi();
        CreateEventData body = ; // CreateEventData | New general information about event
        String eventid = eventid_example; // String | ID of event to update
        try {
            EventObject result = apiInstance.editEvent(body, eventid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EventsApi#editEvent");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Events-editEvent-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Events-editEvent-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Events-editEvent-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">CreateEventData *body = ; // New general information about event
String *eventid = eventid_example; // ID of event to update

EventsApi *apiInstance = [[EventsApi alloc] init];

// modify event object
[apiInstance editEventWith:body
    eventid:eventid
              completionHandler: ^(EventObject output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Events-editEvent-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');

var api = new NotifierResTfulApi.EventsApi()
var body = ; // {{CreateEventData}} New general information about event
var eventid = eventid_example; // {{String}} ID of event to update
...
api.editEvent(bodyeventid, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Events-editEvent-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Events-editEvent-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class editEventExample
    {
        public void main()
        {
            ...
            var apiInstance = new EventsApi();
            var body = new CreateEventData(); // CreateEventData | New general information about event
            var eventid = eventid_example;  // String | ID of event to update
            ...
            {
                Debug.Print("Exception when calling EventsApi.editEvent: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Events-editEvent-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiEventsApi();
$body = ; // CreateEventData | New general information about event
$eventid = eventid_example; // String | ID of event to update

try {
    $result = $api_instance->editEvent($body, $eventid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EventsApi->editEvent: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-editEvent-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EventsApi;

my $api_instance = WWW::SwaggerClient::EventsApi->new();
my $body = WWW::SwaggerClient::Object::CreateEventData->new(); # CreateEventData | New general information about event
my $eventid = eventid_example; # String | ID of event to update

eval { 
    my $result = $api_instance->editEvent(body => $body, eventid => $eventid);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling EventsApi->editEvent: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-editEvent-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # modify event object
    api_response = api_instance.edit_event(body, eventid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling EventsApi->editEvent: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_editEvent_eventid">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                $(document).ready(function() {
                                  var schemaWrapper = {
  "description" : "New general information about event",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/CreateEventData"
  ...
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_editEvent_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_editEvent_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-editEvent-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-editEvent-200-schema">
                                  <div id='responses-editEvent-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "success",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/EventObject"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-editEvent-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-editEvent-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-editEvent-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - update event error occured </h3>
                      ...
                      <hr>
                    <div id="api-Events-getEvent">
                      <article id="api-Events-getEvent-0" data-group="User" data-name="getEvent" data-version="0">
                        <div class="pull-left">
                          <h1>getEvent</h1>
                          <p>get event object</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">you get specific event object by id</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/api/events/{eventid}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Events-getEvent-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Events-getEvent-0-java">Java</a></li>
                          <li class=""><a href="#examples-Events-getEvent-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Events-getEvent-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Events-getEvent-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Events-getEvent-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Events-getEvent-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Events-getEvent-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Events-getEvent-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Events-getEvent-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Events-getEvent-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Events-getEvent-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/events/{eventid}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Events-getEvent-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            EventObject result = apiInstance.getEvent(eventid);
            System.out.println(result);
        } catch (ApiException e) {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Events-getEvent-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Events-getEvent-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Events-getEvent-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *eventid = eventid_example; // ID of event to return

EventsApi *apiInstance = [[EventsApi alloc] init];

// get event object
[apiInstance getEventWith:eventid
              completionHandler: ^(EventObject output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Events-getEvent-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');
...
api.getEvent(eventid, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Events-getEvent-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Events-getEvent-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling EventsApi.getEvent: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Events-getEvent-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->getEvent($eventid);
    print_r($result);
} catch (Exception $e) {
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Events-getEvent-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EventsApi;

my $api_instance = WWW::SwaggerClient::EventsApi->new();
my $eventid = eventid_example; # String | ID of event to return

eval { 
    my $result = $api_instance->getEvent(eventid => $eventid);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling EventsApi->getEvent: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Events-getEvent-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # get event object
    api_response = api_instance.get_event(eventid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling EventsApi->getEvent: %s\n" % e)</code></pre>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_getEvent_eventid">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getEvent-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getEvent-200-schema">
                                  <div id='responses-getEvent-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "success",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/EventObject"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getEvent-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getEvent-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getEvent-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Events-getEventNotifications">
                      <article id="api-Events-getEventNotifications-0" data-group="User" data-name="getEventNotifications" data-version="0">
                        <div class="pull-left">
                          <h1>getEventNotifications</h1>
                          <p>get notifications related to  event object</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">get array of all notification objects related to specific event object</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/api/events/{eventid}/notifications</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Events-getEventNotifications-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Events-getEventNotifications-0-java">Java</a></li>
                          <li class=""><a href="#examples-Events-getEventNotifications-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Events-getEventNotifications-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Events-getEventNotifications-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Events-getEventNotifications-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Events-getEventNotifications-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Events-getEventNotifications-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Events-getEventNotifications-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Events-getEventNotifications-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Events-getEventNotifications-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Events-getEventNotifications-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/events/{eventid}/notifications"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Events-getEventNotifications-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            array[NotificationObject] result = apiInstance.getEventNotifications(eventid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EventsApi#getEventNotifications");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Events-getEventNotifications-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.EventsApi;
...
public class EventsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Events-getEventNotifications-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Events-getEventNotifications-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *eventid = eventid_example; // ID of event

EventsApi *apiInstance = [[EventsApi alloc] init];

// get notifications related to  event object
[apiInstance getEventNotificationsWith:eventid
              completionHandler: ^(array[NotificationObject] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Events-getEventNotifications-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');
...
api.getEventNotifications(eventid, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Events-getEventNotifications-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Events-getEventNotifications-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class getEventNotificationsExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling EventsApi.getEventNotifications: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Events-getEventNotifications-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiEventsApi();
$eventid = eventid_example; // String | ID of event

try {
    $result = $api_instance->getEventNotifications($eventid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EventsApi->getEventNotifications: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-getEventNotifications-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EventsApi;

my $api_instance = WWW::SwaggerClient::EventsApi->new();
my $eventid = eventid_example; # String | ID of event

eval { 
    my $result = $api_instance->getEventNotifications(eventid => $eventid);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling EventsApi->getEventNotifications: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Events-getEventNotifications-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # get notifications related to  event object
    api_response = api_instance.get_event_notifications(eventid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling EventsApi->getEventNotifications: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_getEventNotifications_eventid">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getEventNotifications-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getEventNotifications-200-schema">
                                  <div id='responses-getEventNotifications-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "success",
    ...
    "application/json" : {
      "schema" : {
        ...
        "x-content-type" : "application/json"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getEventNotifications-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getEventNotifications-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getEventNotifications-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-Notifications">
                  <h1>Notifications</h1>
                    <div id="api-Notifications-createNotification">
                      <article id="api-Notifications-createNotification-0" data-group="User" data-name="createNotification" data-version="0">
                        <div class="pull-left">
                          <h1>createNotification</h1>
                          <p>create new notification object</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">you describe notification in request body and get new notification object as response</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/api/notifications/new</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Notifications-createNotification-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Notifications-createNotification-0-java">Java</a></li>
                          <li class=""><a href="#examples-Notifications-createNotification-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Notifications-createNotification-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Notifications-createNotification-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Notifications-createNotification-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Notifications-createNotification-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Notifications-createNotification-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Notifications-createNotification-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Notifications-createNotification-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Notifications-createNotification-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Notifications-createNotification-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/notifications/new"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Notifications-createNotification-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
public class NotificationsApiExample {
    ...
    public static void main(String[] args) {
        ...
        CreateNotificationData body = ; // CreateNotificationData | General information about notification
        try {
            NotificationObject result = apiInstance.createNotification(body);
            System.out.println(result);
        } catch (ApiException e) {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Notifications-createNotification-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Notifications-createNotification-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Notifications-createNotification-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">CreateNotificationData *body = ; // General information about notification

NotificationsApi *apiInstance = [[NotificationsApi alloc] init];

// create new notification object
[apiInstance createNotificationWith:body
              completionHandler: ^(NotificationObject output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Notifications-createNotification-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');

var api = new NotifierResTfulApi.NotificationsApi()
var body = ; // {{CreateNotificationData}} General information about notification
...
api.createNotification(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Notifications-createNotification-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Notifications-createNotification-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class createNotificationExample
    {
        public void main()
        {
            ...
            var body = new CreateNotificationData(); // CreateNotificationData | General information about notification
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling NotificationsApi.createNotification: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Notifications-createNotification-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiNotificationsApi();
$body = ; // CreateNotificationData | General information about notification
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Notifications-createNotification-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::NotificationsApi;

my $api_instance = WWW::SwaggerClient::NotificationsApi->new();
my $body = WWW::SwaggerClient::Object::CreateNotificationData->new(); # CreateNotificationData | General information about notification

eval { 
    my $result = $api_instance->createNotification(body => $body);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling NotificationsApi->createNotification: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Notifications-createNotification-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling NotificationsApi->createNotification: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                $(document).ready(function() {
                                  var schemaWrapper = {
  "description" : "General information about notification",
  "content" : {
    "application/json" : {
      "schema" : {
  ...
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_createNotification_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_createNotification_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-createNotification-201-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-createNotification-201-schema">
                                  <div id='responses-createNotification-201-schema-201' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "new object successfully created",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/NotificationObject"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-createNotification-201-schema-data').val(stringify(schema));
                                        var result = $('#responses-createNotification-201-schema-201');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-createNotification-201-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Notifications-deleteNotification">
                      <article id="api-Notifications-deleteNotification-0" data-group="User" data-name="deleteNotification" data-version="0">
                        <div class="pull-left">
                          <h1>deleteNotification</h1>
                          <p>delete notification object</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">delete specofic notification object by id, this id becomes unavailable</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/api/notifications/{notificationid}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Notifications-deleteNotification-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Notifications-deleteNotification-0-java">Java</a></li>
                          <li class=""><a href="#examples-Notifications-deleteNotification-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Notifications-deleteNotification-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Notifications-deleteNotification-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Notifications-deleteNotification-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Notifications-deleteNotification-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Notifications-deleteNotification-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Notifications-deleteNotification-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Notifications-deleteNotification-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Notifications-deleteNotification-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Notifications-deleteNotification-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/notifications/{notificationid}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Notifications-deleteNotification-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
    ...
    public static void main(String[] args) {
        ...
        NotificationsApi apiInstance = new NotificationsApi();
        String notificationid = notificationid_example; // String | ID of notification to delete
        try {
            apiInstance.deleteNotification(notificationid);
        } catch (ApiException e) {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Notifications-deleteNotification-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Notifications-deleteNotification-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Notifications-deleteNotification-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *notificationid = notificationid_example; // ID of notification to delete

NotificationsApi *apiInstance = [[NotificationsApi alloc] init];

// delete notification object
[apiInstance deleteNotificationWith:notificationid
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-Notifications-deleteNotification-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');

var api = new NotifierResTfulApi.NotificationsApi()
var notificationid = notificationid_example; // {{String}} ID of notification to delete
...
api.deleteNotification(notificationid, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Notifications-deleteNotification-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Notifications-deleteNotification-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling NotificationsApi.deleteNotification: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Notifications-deleteNotification-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiNotificationsApi();
$notificationid = notificationid_example; // String | ID of notification to delete
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Notifications-deleteNotification-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::NotificationsApi;

my $api_instance = WWW::SwaggerClient::NotificationsApi->new();
my $notificationid = notificationid_example; # String | ID of notification to delete

eval { 
    $api_instance->deleteNotification(notificationid => $notificationid);
};
if ($@) {
    warn "Exception when calling NotificationsApi->deleteNotification: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Notifications-deleteNotification-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # delete notification object
    api_instance.delete_notification(notificationid)
except ApiException as e:
    print("Exception when calling NotificationsApi->deleteNotification: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">notificationid*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_deleteNotification_notificationid">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                          ...
                          <h2>Responses</h2>
                            ...
                            <h3> Status: 404 - notification not found by this id </h3>
                            ...
                            <h3> Status: 410 - notification was deleted, this id is not available anymore </h3>
                      ...
                      <hr>
                    <div id="api-Notifications-editNotification">
                      <article id="api-Notifications-editNotification-0" data-group="User" data-name="editNotification" data-version="0">
                        <div class="pull-left">
                          <h1>editNotification</h1>
                          <p>modify notification object</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">edit any field of specific notification object and get modified notification object as response</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/api/notifications/{notificationid}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Notifications-editNotification-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Notifications-editNotification-0-java">Java</a></li>
                          <li class=""><a href="#examples-Notifications-editNotification-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Notifications-editNotification-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Notifications-editNotification-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Notifications-editNotification-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Notifications-editNotification-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Notifications-editNotification-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Notifications-editNotification-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Notifications-editNotification-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Notifications-editNotification-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Notifications-editNotification-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/notifications/{notificationid}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Notifications-editNotification-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
    ...
    public static void main(String[] args) {
        ...
        NotificationsApi apiInstance = new NotificationsApi();
        CreateNotificationData body = ; // CreateNotificationData | New general information about notification
        String notificationid = notificationid_example; // String | ID of notification to update
        try {
            NotificationObject result = apiInstance.editNotification(body, notificationid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling NotificationsApi#editNotification");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Notifications-editNotification-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Notifications-editNotification-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Notifications-editNotification-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">CreateNotificationData *body = ; // New general information about notification
String *notificationid = notificationid_example; // ID of notification to update

NotificationsApi *apiInstance = [[NotificationsApi alloc] init];

// modify notification object
[apiInstance editNotificationWith:body
    notificationid:notificationid
              completionHandler: ^(NotificationObject output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Notifications-editNotification-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');

var api = new NotifierResTfulApi.NotificationsApi()
var body = ; // {{CreateNotificationData}} New general information about notification
var notificationid = notificationid_example; // {{String}} ID of notification to update
...
api.editNotification(bodynotificationid, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Notifications-editNotification-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Notifications-editNotification-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class editNotificationExample
    {
        public void main()
        {

            var apiInstance = new NotificationsApi();
            var body = new CreateNotificationData(); // CreateNotificationData | New general information about notification
            var notificationid = notificationid_example;  // String | ID of notification to update
            ...
            {
                Debug.Print("Exception when calling NotificationsApi.editNotification: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Notifications-editNotification-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiNotificationsApi();
$body = ; // CreateNotificationData | New general information about notification
$notificationid = notificationid_example; // String | ID of notification to update

try {
    $result = $api_instance->editNotification($body, $notificationid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling NotificationsApi->editNotification: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Notifications-editNotification-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::NotificationsApi;

my $api_instance = WWW::SwaggerClient::NotificationsApi->new();
my $body = WWW::SwaggerClient::Object::CreateNotificationData->new(); # CreateNotificationData | New general information about notification
my $notificationid = notificationid_example; # String | ID of notification to update

eval { 
    my $result = $api_instance->editNotification(body => $body, notificationid => $notificationid);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling NotificationsApi->editNotification: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Notifications-editNotification-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # modify notification object
    api_response = api_instance.edit_notification(body, notificationid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NotificationsApi->editNotification: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_editNotification_notificationid">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                $(document).ready(function() {
                                  var schemaWrapper = {
  "description" : "New general information about notification",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/CreateNotificationData"
  ...
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_editNotification_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_editNotification_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-editNotification-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-editNotification-200-schema">
                                  <div id='responses-editNotification-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "success",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/NotificationObject"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-editNotification-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-editNotification-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-editNotification-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Notifications-getEventNotifications">
                      <article id="api-Notifications-getEventNotifications-0" data-group="User" data-name="getEventNotifications" data-version="0">
                        <div class="pull-left">
                          <h1>getEventNotifications</h1>
                          <p>get notifications related to  event object</p>
                        </div>
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Notifications-getEventNotifications-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Notifications-getEventNotifications-0-java">Java</a></li>
                          <li class=""><a href="#examples-Notifications-getEventNotifications-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Notifications-getEventNotifications-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Notifications-getEventNotifications-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Notifications-getEventNotifications-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Notifications-getEventNotifications-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Notifications-getEventNotifications-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Notifications-getEventNotifications-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Notifications-getEventNotifications-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Notifications-getEventNotifications-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Notifications-getEventNotifications-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/events/{eventid}/notifications"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling NotificationsApi#getEventNotifications");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *eventid = eventid_example; // ID of event
...
[apiInstance getEventNotificationsWith:eventid
              completionHandler: ^(array[NotificationObject] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');
...
api.getEventNotifications(eventid, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Notifications-getEventNotifications-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class getEventNotificationsExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling NotificationsApi.getEventNotifications: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    ...
    echo 'Exception when calling NotificationsApi->getEventNotifications: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::NotificationsApi;
...
if ($@) {
    warn "Exception when calling NotificationsApi->getEventNotifications: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Notifications-getEventNotifications-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling NotificationsApi->getEventNotifications: %s\n" % e)</code></pre>
                            </div>
                          </div>
    ...
    "application/json" : {
      "schema" : {
        ...
        "x-content-type" : "application/json"
                      ...
                      <hr>
                    <div id="api-Notifications-getNotification">
                      <article id="api-Notifications-getNotification-0" data-group="User" data-name="getNotification" data-version="0">
                        <div class="pull-left">
                          <h1>getNotification</h1>
                          <p>get notification object</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">you get specific notification object by id</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/api/notifications/{notificationid}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Notifications-getNotification-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Notifications-getNotification-0-java">Java</a></li>
                          <li class=""><a href="#examples-Notifications-getNotification-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Notifications-getNotification-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Notifications-getNotification-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Notifications-getNotification-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Notifications-getNotification-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Notifications-getNotification-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Notifications-getNotification-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Notifications-getNotification-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Notifications-getNotification-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Notifications-getNotification-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://virtserver.swaggerhub.com/Gidsik/NotifierRESTAPI/1.0.0/api/notifications/{notificationid}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Notifications-getNotification-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            NotificationObject result = apiInstance.getNotification(notificationid);
            System.out.println(result);
        } catch (ApiException e) {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Notifications-getNotification-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.NotificationsApi;
...
public class NotificationsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Notifications-getNotification-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Notifications-getNotification-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *notificationid = notificationid_example; // ID of notification to return

NotificationsApi *apiInstance = [[NotificationsApi alloc] init];

// get notification object
[apiInstance getNotificationWith:notificationid
              completionHandler: ^(NotificationObject output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Notifications-getNotification-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var NotifierResTfulApi = require('notifier_res_tful_api');
...
api.getNotification(notificationid, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Notifications-getNotification-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Notifications-getNotification-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling NotificationsApi.getNotification: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Notifications-getNotification-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiNotificationsApi();
$notificationid = notificationid_example; // String | ID of notification to return

try {
    $result = $api_instance->getNotification($notificationid);
    print_r($result);
} catch (Exception $e) {
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Notifications-getNotification-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::NotificationsApi;

my $api_instance = WWW::SwaggerClient::NotificationsApi->new();
my $notificationid = notificationid_example; # String | ID of notification to return

eval { 
    my $result = $api_instance->getNotification(notificationid => $notificationid);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling NotificationsApi->getNotification: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Notifications-getNotification-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # get notification object
    api_response = api_instance.get_notification(notificationid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NotificationsApi->getNotification: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_getNotification_notificationid">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getNotification-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getNotification-200-schema">
                                  <div id='responses-getNotification-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "success",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/NotificationObject"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getNotification-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getNotification-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getNotification-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
